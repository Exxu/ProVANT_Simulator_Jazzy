...
/// @brief This file contains the tests cases for a Control Group Manager that only has a state
/// estimator, and does not have a disturbance generator.
///
...
class ControlGroupManagerWithEstimatorTest : public ControlGroupTestFixture
{
protected:
...
TEST_F(ControlGroupManagerWithEstimatorTest, InitializeParameters)  // NOLINT(cert-err58-cpp)
{
...
TEST_F(ControlGroupManagerWithEstimatorTest, RegistersControlGroup)  // NOLINT(cert-err58-cpp)
{
...
TEST_F(ControlGroupManagerWithEstimatorTest, PublishesTheCorrectMessages)  // NOLINT(cert-err58-cpp)
{
  using namespace std::chrono_literals;
...
TEST_F(ControlGroupManagerWithEstimatorTest, ResetsComponents)  // NOLINT(cert-err58-cpp)
{
  using namespace std::chrono_literals;
