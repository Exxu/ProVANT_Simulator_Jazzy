...
/// @brief This file contains the tests cases for a Control Group Manager that has both a
/// disturbance generator and state estimator.
///
...
class ControlGroupManagerWithEstimatorAndDist : public ControlGroupTestFixture
{
protected:
...
TEST_F(ControlGroupManagerWithEstimatorAndDist, InitializeParameters)  // NOLINT(cert-err58-cpp)
{
...
TEST_F(ControlGroupManagerWithEstimatorAndDist, RegistersControlGroup)  // NOLINT(cert-err58-cpp)
{
...
TEST_F(
  ControlGroupManagerWithEstimatorAndDist, PublishesTheCorrectMessages)  // NOLINT(cert-err58-cpp)
{
  using namespace std::chrono_literals;
...
TEST_F(ControlGroupManagerWithEstimatorAndDist, ResetsComponents)  // NOLINT(cert-err58-cpp)
{
  using namespace std::chrono_literals;
